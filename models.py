...
class Poisson_Model:
	"""
	Poisson Distribution to calculate the most likely point spread (final score) of a match
		and average number of goals each team is likely to score in that match.
		This gives 2 methods of determining Money Line.

		Average goals scored can be determined by calculating “Attack Strength” and “Defence Strength” 
			for each team and comparing them .
			Attack Strength/Defence Strength depend on season average goals scored per league
	"""
	...
	def poisson_pmfs(self, pred_home_goals,
		...
		"""
		Calc pmf given lambda (average value of event)
...
class SVM_Model:
	"""
	Standard C-support vector classification.
	Predicts 'FTR_encoded':
